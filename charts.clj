...
(defmethod set-axis :default
  ...
  ([chart dimension axis]
     ...
     (let [plot (.getPlot chart)
           allowed-types #{org.jfree.chart.plot.XYPlot org.jfree.chart.plot.CategoryPlot #_org.jfree.chart.plot.ContourPlot org.jfree.chart.plot.FastScatterPlot}]
...
(def positions
  {:right  org.jfree.chart.ui.RectangleEdge/RIGHT
   :left   org.jfree.chart.ui.RectangleEdge/LEFT
   :top    org.jfree.chart.ui.RectangleEdge/TOP
   :bottom org.jfree.chart.ui.RectangleEdge/BOTTOM})

(defn ^org.jfree.chart.ui.RectangleEdge as-position [x]
  (or (when (instance? org.jfree.chart.ui.RectangleEdge x) x)
      (get positions x)
      (throw (ex-info "invalid axis-location!" {:x x}))))
...
(def default-heat-legend-options
  {:axis-location :bottom-or-left
   ...
   :margin        (org.jfree.chart.ui.RectangleInsets. 5 5 5 5)
   :padding       (org.jfree.chart.ui.RectangleInsets. 10 10 10 10)
   :strip-width   10
   :position      :right})
  ...
  ([scale scale-axis legend-opts]
   (let [{:keys [axis-location
     ...
     (doto (org.jfree.chart.title.PaintScaleLegend. scale scale-axis)
       ...
       (.setMargin           (org.jfree.chart.ui.RectangleInsets. 5 5 5 5))
       ;(.setFrame            (org.jfree.chart.block.BlockBorder. java.awt.Color/red))
       (.setPadding          (org.jfree.chart.ui.RectangleInsets. 10 10 10 10))
       (.setStripWidth       10)
     ...
     (let [plot (.getPlot chart)
       ...
       (do
         ...
         (doto renderer
           ...
           (.setDefaultPaint java.awt.Color/gray))
         chart))))
     ...
     (let [plot (.getPlot chart)
       ...
       (do
          (doto plot
           ...
           (.setDomainGridlinePaint (java.awt.Color. 235 235 235)))
         (doto renderer
           (.setDefaultOutlinePaint java.awt.Color/white)
           (.setDefaultPaint java.awt.Color/gray))
         chart))))
  ...
  ([chart]
     (let [grid-stroke (java.awt.BasicStroke. 1
       ...
       (if (= (-> plot .getDataset type)
              org.jfree.data.statistics.HistogramDataset)
         (-> plot .getRenderer (.setDefaultPaint java.awt.Color/gray)))
